...
public class SummaryStatistics {
    ...
    public double companyStatsWithStreamAverage() {
        double averageRevenue = companies.stream().mapToDouble(c -> c.revenue).average().orElseThrow();

        System.out.printf("The average revenue of all the companies is %.2f", averageRevenue);

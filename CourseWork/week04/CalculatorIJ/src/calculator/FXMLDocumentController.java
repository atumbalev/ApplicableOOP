...
public class FXMLDocumentController {
    ...
    private enum Operation {
        PLUS, MINUS, DIVIDE, MULT, SQUARE, SQUARE_ROT, LOG_10, NO_OP
    };
    ...
    @FXML
    void btnSqrOnAction(ActionEvent actionEvent) {
        doOperation(Operation.SQUARE);
    }

    @FXML
    void btnSqrtOnAction(ActionEvent actionEvent) {
        doOperation(Operation.SQUARE_ROT);
    }

    @FXML
    void btnLog10OnAction(ActionEvent actionEvent) {
        doOperation(Operation.LOG_10);
    }
